ALTER TABLE `lat_kernel_page` CHANGE `system` `system` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0';
UPDATE `lat_kernel_cache` SET `pages` = '' WHERE `label` = 'forum';

REPLACE INTO `lat_setting` VALUES (21, 'dont_resize_imgs', '<lang:resize_imgs>', 'global', '<lang:about_resize_imgs>', '0|<lang:yes>\r\n1|<lang:no>', 0, 1, 0, 0, 0, 1, 0, 0, 1, 21);

ALTER TABLE `lat_user` ADD `dont_resize_imgs` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0';
...
('on_ucp-name', 'member', 1, 'Changing username'),
('on_msg-', 'member', 1, 'Viewing inbox'),
('on_msg-view', 'member', 1, 'Viewing a private message'),
('on_msg-edit', 'member', 1, 'Editing private message folders'),
('on_msg-new', 'member', 1, 'Composing a private message'),
('on_global-search', 'member', 1, 'Making a new search'),
('on_global-view_search', 'member', 1, 'Viewing search results'),
