ALTER TABLE `lat_kernel_group` ADD `cp_access` TEXT NOT NULL AFTER `superadmin` ;
ALTER TABLE `lat_kernel_cache` ADD `autoload` TINYINT( 1 ) UNSIGNED NOT NULL AFTER `label` ;
UPDATE `lat_kernel_cache` SET `autoload` = '1' WHERE CONVERT( `lat_kernel_cache`.`label` USING utf8 ) = 'config' LIMIT 1 ;
UPDATE `lat_kernel_cache` SET `autoload` = '1' WHERE CONVERT( `lat_kernel_cache`.`label` USING utf8 ) = 'group' LIMIT 1 ;
UPDATE `lat_kernel_cache` SET `autoload` = '1' WHERE CONVERT( `lat_kernel_cache`.`label` USING utf8 ) = 'local' LIMIT 1 ;
UPDATE `lat_kernel_cache` SET `autoload` = '1' WHERE CONVERT( `lat_kernel_cache`.`label` USING utf8 ) = 'page' LIMIT 1 ;
UPDATE `lat_kernel_cache` SET `autoload` = '1' WHERE CONVERT( `lat_kernel_cache`.`label` USING utf8 ) = 'storage' LIMIT 1 ;

ALTER TABLE `lat_kernel_cache` DROP `pages` ;

INSERT INTO `lat_kernel_storage` ( `label` , `data` ) VALUES ('version_cache', '');

ALTER TABLE `lat_kernel_page` ADD `cp` TINYINT( 1 ) NOT NULL ;
ALTER TABLE `lat_kernel_session` ADD `escalated` TINYINT( 1 ) UNSIGNED NOT NULL AFTER `sid` ;
UPDATE `lat_kernel_group` SET `cp_access` = '*' WHERE `lat_kernel_group`.`id` =1 LIMIT 1 ;

ALTER TABLE `lat_kernel_session` CHANGE `act` `act` VARCHAR( 255 ) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL;
ALTER TABLE `lat_forum_profile` DROP `post_replies_polls_own`, DROP `post_replies_polls_other`, DROP `use_html`, DROP `use_search`;

INSERT INTO `lat_kernel_page` (`name`, `file`, `menu`, `menu_url`, `can_search`, `system`, `cp`) VALUES('cp', 'cp/cp', '', '', 0, 0, 1);
INSERT INTO `lat_kernel_page` (`name`, `file`, `menu`, `menu_url`, `can_search`, `system`, `cp`) VALUES('cp_forum', 'forum/cp_forum', '', '', 0, 0, 1);

INSERT INTO `lat_kernel_cache` (`label`, `autoload`, `data`, `cache`) VALUES('page_cp', 0, 'a:9:{i:6;a:6:{s:2:"id";s:1:"6";s:4:"name";s:5:"cache";s:5:"title";s:12:"reload cache";s:4:"link";s:14:"pg=cp;do=cache";s:7:"section";s:8:"advanced";s:6:"config";s:1:"0";}i:7;a:6:{s:2:"id";s:1:"7";s:4:"name";s:7:"reparse";s:5:"title";s:15:"reparse content";s:4:"link";s:16:"pg=cp;do=reparse";s:7:"section";s:8:"advanced";s:6:"config";s:1:"0";}i:3;a:6:{s:2:"id";s:1:"3";s:4:"name";s:5:"forum";s:5:"title";s:14:"forum settings";s:4:"link";s:27:"pg=cp;do=settings;act=forum";s:7:"section";s:5:"forum";s:6:"config";s:1:"1";}i:8;a:6:{s:2:"id";s:1:"8";s:4:"name";s:12:"manage_forum";s:5:"title";s:13:"Manage forums";s:4:"link";s:11:"pg=cp_forum";s:7:"section";s:5:"forum";s:6:"config";s:1:"0";}i:9;a:6:{s:2:"id";s:1:"9";s:4:"name";s:14:"manage_profile";s:5:"title";s:15:"Manage profiles";s:4:"link";s:22:"pg=cp_forum;do=profile";s:7:"section";s:5:"forum";s:6:"config";s:1:"0";}i:4;a:6:{s:2:"id";s:1:"4";s:4:"name";s:6:"member";s:5:"title";s:15:"member settings";s:4:"link";s:28:"pg=cp;do=settings;act=member";s:7:"section";s:7:"members";s:6:"config";s:1:"1";}i:5;a:6:{s:2:"id";s:1:"5";s:4:"name";s:4:"comm";s:5:"title";s:14:"communications";s:4:"link";s:26:"pg=cp;do=settings;act=comm";s:7:"section";s:8:"settings";s:6:"config";s:1:"1";}i:1;a:6:{s:2:"id";s:1:"1";s:4:"name";s:7:"general";s:5:"title";s:7:"general";s:4:"link";s:29:"pg=cp;do=settings;act=general";s:7:"section";s:8:"settings";s:6:"config";s:1:"1";}i:2;a:6:{s:2:"id";s:1:"2";s:4:"name";s:6:"system";s:5:"title";s:6:"system";s:4:"link";s:28:"pg=cp;do=settings;act=system";s:7:"section";s:8:"settings";s:6:"config";s:1:"1";}}', 'a:2:{s:5:"query";a:3:{s:6:"select";s:1:"*";s:4:"from";s:14:"kernel_page_cp";s:5:"order";s:14:"section, title";}s:3:"key";s:2:"id";}');
INSERT INTO `lat_kernel_cache` (`label`, `autoload`, `data`, `cache`) VALUES('module', 0, 'a:2:{i:1;a:10:{s:2:"id";s:1:"1";s:4:"name";s:13:"Latova Kernel";s:6:"author";s:11:"Michael Lat";s:12:"website_name";s:6:"Latova";s:11:"url_website";s:21:"http://www.latova.com";s:11:"url_contact";s:0:"";s:12:"url_download";s:0:"";s:11:"url_version";s:33:"http://www.latova.com/version.php";s:7:"version";s:5:"0.3.0";s:6:"mod_id";s:1:"1";}i:2;a:10:{s:2:"id";s:1:"2";s:4:"name";s:12:"Latova Forum";s:6:"author";s:11:"Michael Lat";s:12:"website_name";s:6:"Latova";s:11:"url_website";s:21:"http://www.latova.com";s:11:"url_contact";s:0:"";s:12:"url_download";s:0:"";s:11:"url_version";s:33:"http://www.latova.com/version.php";s:7:"version";s:5:"0.3.0";s:6:"mod_id";s:1:"2";}}', 'a:2:{s:5:"query";a:2:{s:6:"select";s:1:"*";s:4:"from";s:13:"kernel_module";}s:3:"key";s:2:"id";}');
ALTER TABLE `lat_kernel_cache`  ORDER BY `label`;
...
CREATE TABLE IF NOT EXISTS `lat_kernel_page_cp` (
  ...
  `config` tinyint(1) unsigned NOT NULL,
  PRIMARY KEY  (`id`)
...
(5, 'comm', 'communications', 'pg=cp;do=settings;act=comm', 'settings', 1),
...
(9, 'manage_profile', 'Manage profiles', 'pg=cp_forum;do=profile', 'forum', 0);
...
CREATE TABLE IF NOT EXISTS `lat_kernel_module` (
  ...
  `url_contact` varchar(100) NOT NULL,
  `url_download` varchar(100) NOT NULL,
  `url_version` varchar(100) NOT NULL,
...
(1, 'Latova Kernel', 'Michael Lat', 'Latova', 'http://www.latova.com', '', '', 'http://www.latova.com/version.php', '0.3.0', 1),
(2, 'Latova Forum', 'Michael Lat', 'Latova', 'http://www.latova.com', '', '', 'http://www.latova.com/version.php', '0.3.0', 2);



DROP TABLE IF EXISTS `lat_config`;
CREATE TABLE `lat_config` (
  `name` varchar(20) NOT NULL,
  `value` text NOT NULL,
  `title` varchar(50) NOT NULL,
  `help` text NOT NULL,
  `o` smallint(4) unsigned NOT NULL,
...
REPLACE INTO `lat_config` (`name`, `value`, `title`, `help`, `o`, `type`, `def`, `section`, `extra`) VALUES
...
('gd_version', '-1', 'GD Version', 'Latova uses GD Library to manipulate uploaded images and create captchas. It is highly recommended you have this enabled.', 1004, 4, '-1', 'system', '-1|Auto Detect\r\n0|Disable GD\r\n1|GD 2.0 or greater'),
...
REPLACE INTO `lat_local_lang` (`label`, `pg`, `lid`, `word`) VALUES
('action', '', 1, 'Action'),
