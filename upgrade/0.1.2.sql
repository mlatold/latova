DROP TABLE IF EXISTS `lat_kernel_page`;
...
UPDATE `lat_kernel_cache` SET pages=',forum,topic,post,member,global,' WHERE label like '%forum%';
...
INSERT INTO `lat_kernel_page` (`name`, `file`, `menu`, `menu_url`, `can_search`, `system`) VALUES
('forum', 'forum/forum', '<lang:forums>', '', 2, 1),
('global', 'default/global', '', '', 0, 1),
('login', 'default/login', '', '', 0, 0),
('member', 'default/member', '<lang:members>', '', 0, 0),
('msg', 'default/msg', '', '', 0, 0),
('post', 'forum/post', '', '', 0, 0),
('search', '', '<lang:search>', 'pg=global;do=search', 0, 0),
('topic', 'forum/topic', '', '', 0, 0),
('ucp', 'default/ucp', '', '', 0, 0);



ALTER TABLE `lat_kernel_session` ADD `uagent` VARCHAR( 255 ) NOT NULL AFTER `spider` ;
...
CREATE TABLE IF NOT EXISTS `lat_kernel_bbtag_profile` (
  ...
  `bbtags` text NOT NULL,
  `type` tinyint(1) unsigned NOT NULL,
  `max_img` tinyint(3) unsigned NOT NULL,
  `max_mda` tinyint(3) unsigned NOT NULL,
  `max_smi` tinyint(3) unsigned NOT NULL,
  `max_chr` mediumint(8) unsigned NOT NULL,
  PRIMARY KEY  (`id`)
...
DELETE FROM `lat_kernel_storage` WHERE label='stats_last_user';
DELETE FROM `lat_config` WHERE name='post_length';
DELETE FROM `lat_config` WHERE name='sig_length';
DELETE FROM `lat_config` WHERE name='smiley_limit';

ALTER TABLE `lat_kernel_bbtag` ADD `inherit_img` TINYINT( 1 ) UNSIGNED NOT NULL ,
ADD `inherit_mda` TINYINT( 1 ) UNSIGNED NOT NULL ;
UPDATE `lat_kernel_bbtag` SET `inherit_img` = '1' WHERE `id` =7;

update `lat_local_icon` set is_post=2 WHERE id=25;
update `lat_config` set value='4' WHERE name='smilies_table';
UPDATE `lat_topic_reply` SET data=REPLACE(data, '[youtube]', ' ');
UPDATE `lat_topic_reply` SET data=REPLACE(data, '[/youtube]', ' ');
ALTER TABLE `lat_topic_read` ADD INDEX ( `tid` ); 
ALTER TABLE `lat_topic_read` ADD INDEX ( `uid` );
ALTER TABLE `lat_topic_read` ADD INDEX ( `time` ); 
ALTER TABLE `lat_local_lang` ADD INDEX ( `lid` );
ALTER TABLE `lat_local_skin` ADD INDEX ( `sid` );
ALTER TABLE `lat_topic_reply` ADD INDEX ( `poster_ip` );
ALTER TABLE `lat_topic_reply` ADD INDEX ( `poster_id` );
ALTER TABLE `lat_topic_reply` ADD INDEX ( `poster_time` );
ALTER TABLE `lat_topic_reply` DROP INDEX `data`;
ALTER TABLE `lat_topic` ADD INDEX ( `fid` );
ALTER TABLE `lat_user_lock` ADD INDEX ( `time` );
ALTER TABLE `lat_user_lock` ADD INDEX ( `ip` );

INSERT INTO `lat_config` (`name`, `value`) VALUES('img_0_h', '200');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_0_w', '500');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_1_h', '0');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_1_w', '0');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_2_h', '500');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_2_w', '500');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_3_h', '800');
INSERT INTO `lat_config` (`name`, `value`) VALUES('img_3_w', '500');
INSERT INTO `lat_config` (`name`, `value`) VALUES('search_num', '3');
INSERT INTO `lat_config` (`name`, `value`) VALUES('search_time', '60');

INSERT INTO `lat_config` (`name`, `value`) VALUES('name_change_days', '30');
INSERT INTO `lat_config` (`name`, `value`) VALUES('name_change_num', '3');

ALTER TABLE `lat_topic_reply` ADD FULLTEXT (`data`);
ALTER TABLE `lat_topic` ADD FULLTEXT (`title`);
ALTER TABLE `lat_kernel_msg` ADD FULLTEXT (`data`);
ALTER TABLE `lat_user_profile` ADD FULLTEXT (`signature`);
UPDATE `lat_local_lang` SET label='insufficient_permissions' WHERE label='insufficient_premissions';

ALTER TABLE `lat_kernel_msg` DROP `owner_id`;
ALTER TABLE `lat_kernel_msg` DROP `sent_from_name`;
ALTER TABLE `lat_topic_reply` CHANGE `poster_id` `poster_id` MEDIUMINT( 8 ) UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `lat_topic_reply` DROP `on_htm`;
ALTER TABLE `lat_topic_reply` DROP `on_hid`;
ALTER TABLE `lat_topic` CHANGE `posts` `posts` SMALLINT( 5 ) UNSIGNED NOT NULL DEFAULT '0';




DROP TABLE IF EXISTS `lat_kernel_bbtag`;
CREATE TABLE `lat_kernel_bbtag` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  ...
  `example_opt` varchar(255) NOT NULL,
  `example_opt2` varchar(255) NOT NULL,
  `inherit_img` tinyint(1) unsigned NOT NULL,
  `inherit_mda` tinyint(1) unsigned NOT NULL,
  PRIMARY KEY  (`id`)
...
INSERT INTO `lat_kernel_bbtag` (`id`, `tag`, `file`, `hotkey`, `option`, `no_imbed`, `no_quote`, `placement`, `replace`, `display`, `clean`, `example`, `example_opt`, `example_opt2`, `inherit_img`, `inherit_mda`) VALUES
...
(12, 's', '', '', 0, 0, 0, 0, '<del><!-- data --></del>', '', 0, '', '', '', 0, 0),
(13, 'sub', '', '', 0, 1, 0, 0, '<sub><!-- data --></sub>', '', 1, '', '', '', 0, 0),
(14, 'sup', '', '', 0, 1, 0, 0, '<sup><!-- data --></sup>', '', 1, '', '', '', 0, 0),
(15, 'list', 'list', '', 2, 0, 0, 0, '', '', 0, '<br />[*]item1<br />[*]item2<br />', '<br />[*]item1<br />[*]item2<br />', 'o', 0, 0),
(16, 'center', '', '', 0, 0, 0, 206, '<!-- center --><div style="text-align: center"><!-- data --></div><!-- end center -->', '', 0, '', '', '', 0, 0),
(17, 'right', '', '', 0, 0, 0, 0, '<!-- right --><div style="text-align: right"><!-- data --></div><!-- end right -->', '', 0, '', '', '', 0, 0),
(18, 'post', '', '', 0, 1, 0, 0, '<a href="index.php?post=<!-- data -->"><img src="<!-- IMAGE -->link.png" alt="" /></a>', '', 0, '1', '', '', 0, 0);
