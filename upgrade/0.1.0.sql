...
ALTER TABLE `lat_kernel_msg` DROP `sent_from_name`;

DROP TABLE IF EXISTS `lat_kernel_bbtag`;
CREATE TABLE IF NOT EXISTS `lat_kernel_bbtag` (
  ...
  `no_imbed` tinyint(1) unsigned NOT NULL default '0',
  `no_quote` tinyint(1) unsigned NOT NULL default '0',
  `no_sig` tinyint(1) unsigned NOT NULL default '0',
  `maxuses` tinyint(10) unsigned NOT NULL default '0',
...
INSERT INTO `lat_kernel_bbtag` (`id`, `tag`, `name`, `bname`, `file`, `hotkey`, `option`, `no_imbed`, `no_quote`, `no_sig`, `maxuses`, `placement`, `replace`, `display`, `clean`) VALUES 
(1, 'b', 'Bold Text', 'B', '', 'b', 0, 0, 0, 0, 0, 100, '<b><!-- data --></b>', '', 0),
(2, 'u', 'Underline', 'U', '', 'u', 0, 0, 0, 0, 0, 101, '<u><!-- data --></u>', '', 0),
(3, 'i', 'Italic', 'I', '', 'i', 0, 0, 0, 0, 0, 102, '<i><!-- data --></i>', '', 0),
(4, 'color', 'Font Color', 'COLOR', 'color', '', 1, 0, 0, 0, 0, 103, '<span <!-- optn -->><!-- data --></span>', 'Blue|blue|color:blue\r\nRed|red|color:red\r\nPurple|purple|color:purple\r\nGray|gray|color:gray\r\nGreen|green|color:green\r\nOrange|orange|color:orange', 0),
(5, 'font', 'Font Face', 'FONT', 'letters_numbers_spaces', '', 1, 0, 0, 0, 0, 104, '<span style="font-family: <!-- optn -->;"><!-- data --></span>', 'Arial|arial|font-family: arial; font-size: 10px;\r\nComic Sans|Comic Sans MS|font-family: Comic Sans MS; font-size: 10px;\r\nCourier|Courier New|font-family: Courier New; font-size: 10px;\r\nLucida|Lucida Console|font-family: Lucida Console; font-size: 10px;\r\nTahoma|Tahoma|font-family: Tahoma; font-size: 10px;\r\nTimes Roman|Times New Roman|font-family: Times New Roman; font-size: 10px;', 0),
(6, 'size', 'Font Size', 'SIZE', 'size', '', 1, 0, 0, 0, 0, 105, '<span style="font-size: <!-- optn -->px;"><!-- data --></span>', 'Small|8\r\nLarge|15\r\nLarger|19\r\nLargest|23', 0),
(7, 'img', 'Insert Image', 'IMAGE', 'image', 'm', 0, 0, 0, 0, 10, 200, '<img src="<!-- data -->" alt="img" />', '', 1),
(8, 'url', 'Hyperlink', 'LINK', 'url', 'l', 2, 0, 0, 0, 0, 201, '', '', 0),
(9, 'mail', 'Insert Email Address', 'MAIL', 'mail', 'e', 0, 0, 0, 0, 0, 202, '<a href="mailto:<!-- optn -->"><!-- data --></a>', '', 1),
(10, 'quote', 'Basic Quote', 'QUOTE', 'quote', 'q', 2, 1, 1, 0, 0, 203, '<div class="bdr_bb">\r\n	<div class="quote">\r\n		<!-- optn -->\r\n	</div>\r\n	<div class="quote_text">\r\n		<!-- data -->\r\n	</div>\r\n</div>', '', 0),
(11, 'code', 'Code', 'CODE', 'code', 'c', 0, 1, 0, 0, 0, 204, '<div class="bdr_bb">\r\n	<div class="code">\r\n		<lang:code>\r\n	</div>\r\n	<div class="code_text">\r\n		<!-- data -->\r\n	</div>\r\n</div>', '', 2),
(12, 'codebox', 'Codebox', '', 'codebox', '', 0, 1, 0, 0, 0, 0, '<div class="bdr_bb">\r\n	<div class="code">\r\n		<lang:codebox>\r\n	</div>\r\n	<textarea class="codebox_text" rows="10" cols="50"><!-- data --></textarea>\r\n</div>', '', 1),
(13, 's', 'Strikethrough', '', '', '', 0, 0, 0, 0, 0, 0, '<del><!-- data --></del>', '', 0),
(14, 'sub', 'Subscript', '', '', '', 0, 1, 0, 0, 0, 0, '<sub><!-- data --></sub>', '', 1),
(15, 'sup', 'Superscript', '', '', '', 0, 1, 0, 0, 0, 0, '<sup><!-- data --></sup>', '', 1),
(16, 'list', 'List', '', 'list', '', 2, 0, 0, 0, 0, 0, '', '', 0),
(17, 'center', 'CENTER', '', '', '', 0, 0, 0, 0, 0, 0, '<!-- center --><div style="text-align: center"><!-- data --></div><!-- end center -->', '', 0),
(18, 'right', 'RIGHT', '', '', '', 0, 0, 0, 0, 0, 0, '<!-- right --><div style="text-align: right"><!-- data --></div><!-- end right -->', '', 0),
(19, 'post', 'POST', '', '', '', 0, 1, 0, 0, 0, 0, '<a href="index.php?post=<!-- data -->"><img src="<!-- IMAGE -->link.png" alt=""></a>', '', 0),
(20, 'youtube', 'YouTube Video', '', 'youtube', '', 0, 0, 0, 1, 3, 0, '<object width="550" height="425"><param name="movie" value="http://www.youtube.com/v/<!-- data -->" /><embed src="http://www.youtube.com/v/<!-- data -->" type="application/x-shockwave-flash" width="550" height="425" /></object>', '', 1);




REPLACE INTO `lat_local_skin` (`label`, `pg`, `sid`, `skin`) VALUES 
('action', '', 1, '<div id="action" onmousedown="get_element(''action'').style.display = ''none''">\r\n	<div class="bdr">\r\n		<h1><a href="#"><img src="{$this->lat->image_url}close.png" alt="X" /></a>{$this->lat->lang[''action'']}</h1>\r\n		<div class="bdr2" style="padding: 15px 0px 15px 0px">\r\n			<div style="float: left; width: 40px; text-align: center;"><img src="{$this->lat->image_url}msg_action.png" alt="" /></div>\r\n			<div style="margin-left: 44px">\r\n				<i>{$this->lat->lang[''act_''.$this->lat->user[''act'']]}</i>\r\n			</div>\r\n		</div>\r\n	</div>\r\n	<div class="clear"></div>\r\n</div>'),
...
('bb_button', '', 1, '<input type="button" tabindex="10" name="{$this->lat->cache[''bbtag''][$bb[''id'']][''bbcode'']}" onclick="bbInsert(''[{$this->lat->cache[''bbtag''][$bb[''id'']][''tag'']}]'', ''[/{$this->lat->cache[''bbtag''][$bb[''id'']][''tag'']}]'', ''{$this->lat->cache[''bbtag''][$bb[''id'']][''tag'']}'');" value="&nbsp;{$this->lat->cache[''bbtag''][$bb[''id'']][''bname'']}&nbsp;" class="form_bb_button" accesskey="{$this->lat->cache[''bbtag''][$bb[''id'']][''hotkey'']}" />&nbsp;'),
...
('menu', '', 1, '<li{$first}><a href="{$this->lat->url}{$this->lat->cache[''page''][$m][''menu_url'']}">{$this->lat->cache[''page''][$m][''menu'']}</a></li>'),
('nav', '', 1, '\r\n	<div class="navigation">\r\n		<div>\r\n			{$nav}\r\n		</div>\r\n	</div>'),
('pm_more', '', 1, '<div id="pm_popup" style="position: absolute; display: none; width: 600px;" class="bdr">\r\n	<h1><a href="javascript:toggle(''pm_popup'');"><img src="{$this->lat->image_url}close.png" alt="X" id="img_pm_popup"></a>{$this->lat->lang[''new_pms'']}</h1>\r\n	<div class="bdr2">\r\n		<div style="float: left; width: 150px; text-align: center;">\r\n			{$pm_fetch[''avatar'']}\r\n		</div>\r\n		<div style="margin-left: 160px; text-align: center;">\r\n			{$this->lat->lang[''pm_numbers'']}<br /><br />\r\n			<span class="tiny_text">\r\n				<a href="{$this->lat->url}pm={$pm_fetch[''id'']}">{$this->lat->lang[''view_this'']}</a><br />\r\n				<a href="{$this->lat->url}pm={$pm_fetch[''id'']}" target="_blank" onclick="toggle(''pm_popup'');">{$this->lat->lang[''view_new'']}</a><br /><br />\r\n				<a href="{$this->lat->url}pg=msg">{$this->lat->lang[''view_inbox'']}</a> &nbsp; &middot; &nbsp; <a href="javascript:toggle(''pm_popup'');">{$this->lat->lang[''hide_this'']}</a>\r\n			</span>\r\n		</div>\r\n		<div style="clear: both"></div>\r\n	</div>\r\n</div>\r\n'),
('pm_one', '', 1, '<div id="pm_popup" style="position: absolute; display: none; width: 600px;" class="bdr">\r\n	<h1><a href="javascript:toggle(''pm_popup'');"><img src="{$this->lat->image_url}close.png" alt="X" id="img_pm"></a>{$this->lat->lang[''new_pm'']}</h1>\r\n	<div class="bdr2">\r\n		<div style="float: left; width: 150px; text-align: center;">\r\n			{$pm_fetch[''avatar'']}\r\n		</div>\r\n		<div style="margin-left: 160px; text-align: center;">\r\n			{$this->lat->lang[''pm_number'']}<br /><br />\r\n			<span class="tiny_text">\r\n				<a href="{$this->lat->url}pm={$pm_fetch[''id'']}">{$this->lat->lang[''view_this'']}</a><br />\r\n				<a href="{$this->lat->url}pm={$pm_fetch[''id'']}" target="_blank" onclick="toggle(''pm_popup'');">{$this->lat->lang[''view_new'']}</a><br /><br />\r\n				<a href="{$this->lat->url}pg=msg">{$this->lat->lang[''view_inbox'']}</a> &nbsp; &middot; &nbsp; <a href="javascript:toggle(''pm_popup'');">{$this->lat->lang[''hide_this'']}</a>\r\n			</span>\r\n		</div>\r\n		<div style="clear: both"></div>\r\n	</div>\r\n</div>\r\n'),
...
('qs', '', 1, '<form action="{$this->lat->url}pg=global;do=submit_search;quick=1" method="post">\r\n			<input type="text" class="quick" size="10" name="quicksearch" value="{$this->lat->lang[''qs_text'']}" tabindex="100" onfocus="cleart(this, ''{$this->lat->lang[''qs_text'']}'');" />\r\n			<select name="quicktype" tabindex="100" class="quick">\r\n				{$qs_opt}\r\n			</select>\r\n			<input type="submit" class="quick_button" value="Go" name="submit" tabindex="100" />\r\n			</form>'),
('sig_show', '', 1, '<div class="signature_line"></div><div class="signature_text"{$sig_height}>{$sig}</div>'),
('site_statistics', '', 1, '<div class="clear"></div>\r\n<div class="bdr">\r\n	<h1>{$div[0]}{$this->lat->lang[''statistics'']}</h1>\r\n	<div class="bdr2" id="online" style="{$div[1]}">\r\n		<div style="float: right; text-align: right;" class="tiny_text">\r\n			<a href="{$this->lat->url}pg=member;do=online">{$this->lat->lang[''users_full_online'']}</a><br />\r\n			<!-- <a href="{$this->lat->url}">{$this->lat->lang[''users_more'']}</a> -->\r\n		</div>\r\n		<div style="float: left; width: 50px; text-align: center; padding: 5px 0px 0px 0px;"><a href="{$this->lat->url}pg=member;do=online"><img src="{$this->lat->image_url}online.png" alt="" /></a></div>\r\n		<div style="margin-left: 50px;">\r\n			{$this->lat->lang[''member_stats'']}<br />\r\n			{$this->lat->lang[''most_users'']}<br />\r\n			{$this->lat->lang[''online_main'']}\r\n			<blockquote>{$active}</blockquote>\r\n		</div>\r\n	</div>\r\n</div>'),
...
('profile', 'member', 1, '<div class="bdr">\r\n	<h1>{$this->lat->lang[''viewing_profile'']}{$profile[''name'']}</h1>\r\n	<div class="bdr2">\r\n		<div style="float: left; width: 50%; overflow: hidden;">\r\n			<h4>{$profile[''name'']}</h4>\r\n			<div><span class="user_title">{$profile[''user_title'']}</span></div>\r\n			{$profile[''avatar'']}\r\n		</div>\r\n		<div style="float: left; width: 50%; overflow: hidden; text-align: right;">\r\n			{$profile[''photo'']}\r\n		</div>\r\n		<div style="clear: both" class="clear"></div>\r\n		<div style="float: left; width: 48%; overflow: hidden;">\r\n			<h2>{$this->lat->lang[''contact_details'']}</h2>\r\n			<div class="bdr2">\r\n				<div><div class="icon_profile"><img src="{$this->lat->image_url}send_pm.png" alt="" /></div><a href="{$this->lat->url}pg=msg;do=new;user={$profile[''id'']}">{$this->lat->lang[''send_pm'']}</a></div>{$profile[''im'']}\r\n			</div>\r\n		</div>\r\n		<div style="float: right; width: 48%; overflow: hidden;">\r\n			<h2>{$this->lat->lang[''user_statistics'']}</h2>\r\n			<div class="bdr2">\r\n				<b>{$this->lat->lang[''joined_date'']}</b>{$profile[''registered'']}<br />\r\n				<b>{$this->lat->lang[''last_login'']}</b>{$profile[''last_login'']}{$content[''stats'']}\r\n			</div>\r\n		</div>\r\n		<div style="clear: both" class="clear"></div>\r\n		{$profile[''signature_cached'']}{$profile[''data'']}\r\n	</div>\r\n</div>'),
('search', 'member', 1, '<form action="{$this->lat->url}pg=global;do=submit_search;branch={$this->lat->input[''branch'']}" method="post" id="moderate">\r\n<div class="bdr">\r\n{$this->lat->output}\r\n</div>\r\n</form>'),
('sig', 'member', 1, '	<h2>{$this->lat->lang[''signature'']}</h2>\r\n	<div class="bdr2">\r\n		<span class="signaturetext">\r\n			{$profile[''signature_cached'']}\r\n		</span>\r\n	</div>\r\n	<div class="clear"></div>'),
('search_topic', 'misc', 1, '	<div class="head">\r\n		<div class="headp">\r\n			<span class="headtext">{$this->lat->lang[''search'']}</span>\r\n		</div>\r\n	</div>\r\n	<div class="subhead">\r\n		<div class="subp"" style="float: left; width: 50%;">\r\n			{$this->lat->lang[''findresults'']}\r\n		</div>\r\n		<div class="subp">\r\n			{$this->lat->lang[''serachoptions'']}\r\n		</div>\r\n	</div>\r\n	<div class="cbdr">\r\n		<div style="float: left; width: 50%;">\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''withall'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<input type="text" class="formtbalt" size="30" name="all" value="{$error[''all'']}" tabindex="1" />\r\n			</div>\r\n			<div style="clear: both"></div>\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''withany'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<input type="text" class="formtbalt" size="30" name="any" value="{$error[''any'']}" tabindex="1" />\r\n			</div>\r\n			<div style="clear: both"></div>\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''withnone'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<input type="text" class="formtbalt" size="30" name="none" value="{$error[''none'']}" tabindex="1" />\r\n			</div>\r\n			<div style="clear: both"></div>\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''withuser'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<input type="text" class="formtbalt" size="30" name="user" value="{$error[''user'']}" tabindex="1" />\r\n			</div>\r\n		</div>\r\n		<div style="float: right; width: 50%;">\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''orderresults'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<select name="order" class="formd" tabindex="2">\r\n					<option value="lastd"{$error[''lastd'']}>{$this->lat->lang[''sorderlastpostdate'']}</option>\r\n					<option value="rel"{$error[''rel'']}>{$this->lat->lang[''srelevance'']}</option>\r\n					<option value="views"{$error[''views'']}>{$this->lat->lang[''sviews'']}</option>\r\n					<option value="replies"{$error[''replies'']}>{$this->lat->lang[''sreplies'']}</option>\r\n				</select>\r\n			</div>\r\n			<div style="clear: both"></div>\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''orientation'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<select name="or" class="formd" tabindex="2">\r\n					<option value="desc"{$error[''desc'']}>{$this->lat->lang[''desc'']}</option>\r\n					<option value="asc"{$error[''asc'']}>{$this->lat->lang[''asc'']}</option>\r\n				</select>\r\n			</div>\r\n			<div style="clear: both"></div>\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''showresultsas'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<select name="res" class="formd" tabindex="2">\r\n					<option value="posts"{$error[''posts'']}>{$this->lat->lang[''sposts'']}</option>\r\n					<option value="topics"{$error[''topics'']}>{$this->lat->lang[''stopics'']}</option>\r\n				</select>\r\n			</div>\r\n			<div style="clear: both"></div>\r\n			<div class="searchleft">\r\n				{$this->lat->lang[''seachin'']}&nbsp;\r\n			</div>\r\n			<div class="searchright">\r\n				<select name="searchin" class="formd" tabindex="2">\r\n					<option value="msg"{$error[''msg'']}>{$this->lat->lang[''smsgtext'']}</option>\r\n					<option value="title"{$error[''title'']}>{$this->lat->lang[''stitle'']}</option>\r\n				</select>\r\n			</div>\r\n		</div>\r\n		<div class="clear"></div>\r\n		<div style="text-align: center">\r\n			{$dropdown}\r\n		</div>\r\n		<div class="footrow">\r\n			<input type="submit" class="formb" value="{$this->lat->lang[''search'']}" name="submit" tabindex="3" />\r\n		</div>\r\n	</div>'),
...
('main_page', 'ucp', 1, '<div class="bdr">\r\n	<h1>{$this->lat->lang[''settings'']}</h1>\r\n	<h2>{$this->lat->lang[''personalization'']}</h2>\r\n	<div class="bdr2">\r\n		<div style="float: left; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=config;sc=profile">{$this->lat->lang[''profile'']}</a></h4><span class="tiny_text">{$this->lat->lang[''about_profile'']}</span></div>\r\n		<div style="float: right; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=signature">{$this->lat->lang[''signature'']}</a></h4><span class="tiny_text">{$this->lat->lang[''about_signature'']}</span></div>\r\n		<div class="clear" style="clear: both"></div>\r\n		<div style="float: left; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=avatar">{$this->lat->lang[''avatar'']}</a></h4><span class="tiny_text">{$this->lat->lang[''about_avatar'']}</span></div>\r\n		<div style="float: right; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=photo">{$this->lat->lang[''photo'']}</a></h4><span class="tiny_text">{$this->lat->lang[''about_photo'']}</span></div>\r\n		<div class="clear" style="clear: both"></div>\r\n	</div>\r\n	<h2>{$this->lat->lang[''module_settings'']}</h2>\r\n	<div class="bdr2">{$module_pages}\r\n	</div>\r\n	<h2>{$this->lat->lang[''account_configuration'']}</h2>\r\n	<div class="bdr2">\r\n		<div style="float: left; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=email">{$this->lat->lang[''change_email'']}</a></h4><span class="tiny_text">{$this->lat->lang[''about_change_email'']}</span></div>\r\n		<div style="float: right; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=passwd">{$this->lat->lang[''change_password'']}</a></h4><span class="tiny_text">{$this->lat->lang[''about_change_password'']}</span></div>\r\n		<div class="clear" style="clear: both"></div>\r\n	</div>\r\n</div>'),
('main_page_link', 'ucp', 1, '		<div style="float: {$float}; width: 50%;"><h4><a href="{$this->lat->url}pg=ucp;do=config;sc={$page[''name'']}">{$page[''title'']}</a></h4><span class="tiny_text">{$page[''description'']}</span></div>'),
...
('b', '', 1, ' byte'),
('bbtag_off', '', 1, 'BBtags are <b>DISABLED</b>.'),
('bbtag_on', '', 1, 'BBtags are <b>ENABLED</b>.'),
('bs', '', 1, ' bytes'),
('bshort', '', 1, 'b'),
...
('err_invalid_chr', '', 1, 'Your desired username contains invalid characters.'),
...
('help_guest', '', 1, 'A screen name which will represent you on this website. It will appear next to the content you are about to submit, so that others may identify you. It is recommended that you register an account and login so nobody can impersonate you.&lt;br /&gt;&lt;br /&gt;&lt;i&gt;Invalid characters: [ ] ;&lt;br /&gt;Length: 1-25 characters.&lt;/i&gt;'),
('hide', '', 1, 'Hide'),
('hide_this', '', 1, 'Hide notification'),
('html_off', '', 1, 'HTML is <b>DISABLED</b>.'),
('html_on', '', 1, 'HTML is <b>ENABLED</b>.'),
('hundred', '', 1, '100%'),
('icq', '', 1, 'ICQ'),
('inbox_header', '', 1, 'Inbox (<!-- NUM -->)'),
('insufficient_premissions', '', 1, 'Insufficient permissions'),
...
('new_pms', '', 1, 'New Private Messages'),
('none', '', 1, 'None'),
...
('online_main', '', 1, 'There <!-- USERS --> online (<!-- MEMBERS --> &amp; <!-- GUESTS -->).'),
('page', '', 1, 'page'),
('pages', '', 1, 'pages:'),
('php', '', 1, 'PHP Code'),
('pm_number', '', 1, 'You have received one new private message from <!-- USER --> waiting in your inbox titled "<i><!-- TITLE --></i>".'),
('pm_numbers', '', 1, 'You have <!-- NUM --> new private messages waiting in your inbox. The most recent private message is from <!-- USER --> titled "<i><!-- TITLE --></i>".'),
('preview', '', 1, 'Preview'),
('qs_text', '', 1, 'search  '),
('qs_topic', '', 1, 'posts'),
('quote', '', 1, 'Quote:'),
...
('said', '', 1, 'said:'),
('search', '', 1, 'Search'),
('searchresults', '', 1, 'Search Results'),
...
('smiley', '', 1, 'Smiley'),
('smilies', '', 1, 'Smilies'),
('spidersin', '', 1, '<br />Spiders online: <!-- SPIDERS -->.'),
...
('users_full_online', '', 1, 'View full online list'),
('users_more', '', 1, 'More statistics'),
('user_title', '', 1, 'User Title'),
('view_inbox', '', 1, 'Go to inbox'),
('view_new', '', 1, 'View this message in new window'),
('view_this', '', 1, 'View this message in current window'),
('website', '', 1, 'Website'),
('xmllang', '', 1, 'en'),
('yesterday', '', 1, 'Yesterday,'),
('yim', '', 1, 'Yahoo Instant Messenger'),
('zero', '', 1, '0%'),
('reg_activate', 'email', 1, 'Hey <!-- NAME -->,\r\n\r\nHere is the activation link (copy and paste it)\r\nmaplantis.org/?pg=login;do=submit_validate;id=<!-- ID -->;code=<!-- CODE -->\r\n\r\nYou may need to copy and paste it into your browser.\r\n\r\nIf the above link does not work, you may go here:\r\nLink: maplantis.org/?pg=login;do=validate\r\n\r\nActivation ID: <!-- ID -->\r\nActivation Code: <!-- CODE -->\r\n\r\nThank you!'),
('re_activate', 'email', 1, 'Hey <!-- NAME -->,\r\n\r\nHere is the activation link (copy and paste it)\r\nmaplantis.org/?pg=login;do=submit_validate;id=<!-- ID -->;code=<!-- CODE -->\r\n\r\nYou may need to copy and paste it into your browser.\r\n\r\nIf the above link does not work, you may go here:\r\nLink: maplantis.org/?pg=login;do=validate\r\n\r\nActivation ID: <!-- ID -->\r\nActivation Code: <!-- CODE -->\r\n\r\nThank you!'),
...
('allfselected', 'member', 1, 'Searching all forums. Click here to select individual forums.'),
('asc', 'member', 1, 'Ascending'),
...
('desc', 'member', 1, 'Descending'),
('errchangeqs', 'member', 1, 'You didn''t change the quick search textbox.'),
('errnosearch', 'member', 1, 'No search results were found. Check for spelling errors or use different generic keywords and try again.'),
('errnosearchrec', 'member', 1, 'No search record found. It may have expired or never existed.'),
('errsearch', 'member', 1, 'You did not fill out either the all or any keyword textboxes. Fill at least one of them out and try your search again.'),
('errsearchflood', 'member', 1, 'You have attempted too many searches. Please wait at least <!-- NUM --> seconds and try again.'),
('errsearchforums', 'member', 1, 'No valid forums were selected to search.'),
('errsearchpre', 'member', 1, 'You don''t have permission to search in this section.'),
('errsearchshort', 'member', 1, 'One or more keywords and/or phrases are under 4 characters.'),
('errsearchtime', 'member', 1, 'You have made a search very recently. Please wait and try your search again within 20 seconds.'),
('errsearchuser', 'member', 1, 'You are not the original creator of this search. Try to create a new search.'),
('err_no_user', 'member', 1, 'This user does not exist.'),
('findresults', 'member', 1, 'Find Results'),
...
('on_error-', 'member', 1, 'Encountered an error'),
('on_forum-', 'member', 1, 'Viewing forum index'),
('on_forum-view', 'member', 1, 'Viewing forum: <a href="<!-- URL -->forum=<!-- ID -->"><!-- EXTRA --></a>'),
('on_login-', 'member', 1, 'Logging in'),
('on_login-lost_pass', 'member', 1, 'Sending lost password email'),
('on_login-manual_reset', 'member', 1, 'Manually reseting password'),
('on_login-manual_validate', 'member', 1, 'Manually validating a user account'),
('on_login-register', 'member', 1, 'Creating a new user account'),
('on_login-resend', 'member', 1, 'Resending a validation email'),
('on_login-reset', 'member', 1, 'Resetting account password'),
('on_member-', 'member', 1, 'Viewing Member List'),
('on_member-online', 'member', 1, 'Viewing the online list'),
('on_member-profile', 'member', 1, 'Viewing member profile: <a href="<!-- URL -->member=<!-- ID -->"><!-- EXTRA --></a>'),
('on_post-edit', 'member', 1, 'Editing reply in <a href="<!-- URL -->pg=topic;do=find;id=<!-- ID -->"><!-- EXTRA --></a>'),
('on_post-reply', 'member', 1, 'Posting a new reply in <a href="<!-- URL -->topic=<!-- ID -->"><!-- EXTRA --></a>'),
('on_post-topic', 'member', 1, 'Posting a new topic in <a href="<!-- URL -->forum=<!-- ID -->"><!-- EXTRA --></a>'),
('on_topic-', 'member', 1, 'Viewing topic: <a href="<!-- URL -->topic=<!-- ID -->"><!-- EXTRA --></a>'),
('on_ucp-', 'member', 1, 'Viewing dashboard overview'),
('on_ucp-avatar', 'member', 1, 'Choosing a new avatar'),
('on_ucp-config', 'member', 1, 'Updating account configuration'),
('on_ucp-email', 'member', 1, 'Changing account email'),
('on_ucp-passwd', 'member', 1, 'Changing account password'),
('on_ucp-photo', 'member', 1, 'Choosing a new photo'),
('on_ucp-signature', 'member', 1, 'Editing signature'),
('on_unknown', 'member', 1, 'Viewing the website'),
('orderresults', 'member', 1, 'Order results by:'),
('orientation', 'member', 1, 'Orientation: '),
('other', 'member', 1, 'Other'),
('per_day', 'member', 1, ' (<!-- NUM --> per day)'),
('seachin', 'member', 1, 'Search in:'),
('search_topic', 'member', 1, 'Topics'),
('send_pm', 'member', 1, 'Send Private Message to <!-- NAME -->'),
('serachoptions', 'member', 1, 'Search Options'),
('showresultsas', 'member', 1, 'Show results as:'),
('signature', 'member', 1, 'Signature'),
('smsgtext', 'member', 1, 'Message Text'),
('sorderlastpostdate', 'member', 1, 'Last Post Date'),
('sposts', 'member', 1, 'Posts'),
('srelevance', 'member', 1, 'Relevance'),
('sreplies', 'member', 1, 'Replies'),
('stitle', 'member', 1, 'Titles'),
('stopics', 'member', 1, 'Topics'),
('sviews', 'member', 1, 'Views'),
...
('withall', 'member', 1, 'With <b>all</b> of these words:'),
('withany', 'member', 1, 'With <b>any</b> of these words:'),
('withnone', 'member', 1, 'With <b>none</b> of these words:'),
('withuser', 'member', 1, 'Posted by this user:'),
...
('confirm_delete_post', 'topic', 1, 'ARE YOU SURE YOU WISH TO DELETE THIS POST?'),
